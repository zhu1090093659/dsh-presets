window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:src/client/preset-center.module.css.mjs
		const css = "._6yuPUG_panel{flex-direction:column;gap:10px;display:flex}._6yuPUG_search{box-sizing:border-box;width:100%;font:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;padding:7px 10px;font-size:13px}._6yuPUG_search:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}._6yuPUG_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:14px 0;font-size:13px}._6yuPUG_list{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}._6yuPUG_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-direction:column;gap:6px;padding:12px;display:flex}._6yuPUG_cardHead{flex-wrap:wrap;align-items:baseline;gap:6px 10px;min-width:0;display:flex}._6yuPUG_cardName{color:var(--dsw-alias-label-primary);font-weight:600}._6yuPUG_cardName a{color:inherit;text-decoration:none}._6yuPUG_cardName a:hover{text-decoration:underline}._6yuPUG_version{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;margin-left:6px;font-size:11px}._6yuPUG_cardMeta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:center;gap:4px 8px;font-size:11px;display:flex}._6yuPUG_cardDesc{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;line-height:1.45}._6yuPUG_badgeMuted,._6yuPUG_badgeOn,._6yuPUG_badgeOff,._6yuPUG_badgeWarn,._6yuPUG_badgeCode{white-space:nowrap;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:0 8px;font-size:11px;line-height:1.6}._6yuPUG_badgeOn{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}._6yuPUG_badgeWarn{color:var(--dsw-alias-label-error,#c53030)}._6yuPUG_badgeCode{color:var(--dsw-alias-label-primary)}._6yuPUG_profile{flex-wrap:wrap;align-items:center;gap:6px;margin:0;display:flex}._6yuPUG_profileText{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:1.5}._6yuPUG_actions{flex-wrap:wrap;gap:6px;display:flex}._6yuPUG_actions>button{font-size:12px}._6yuPUG_primary{color:var(--dsw-alias-label-primary-foreground);background:var(--dsw-alias-button-primary-fill);border-color:var(--dsw-alias-button-primary-fill)}._6yuPUG_primary:hover:enabled{background:var(--dsw-alias-button-primary-hover);border-color:var(--dsw-alias-button-primary-hover)}._6yuPUG_primary:disabled{opacity:.55;cursor:default}._6yuPUG_secondary{color:var(--dsw-alias-label-primary)}._6yuPUG_danger{color:var(--dsw-alias-label-error,#c53030)}._6yuPUG_note{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:1.5}._6yuPUG_inlineButton{margin-left:8px;font-size:12px}._6yuPUG_viewer{white-space:pre;max-height:46vh;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;margin:0;padding:10px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;line-height:1.5;overflow:auto}._6yuPUG_modalActions{justify-content:flex-end;gap:8px;margin-top:12px;display:flex}";
		const tagId = "@linxin666/dsh-client-ui-preset-center/src/client/preset-center.module.css";
		...
		var preset_center_module_css_default = {
			"actions": "_6yuPUG_actions",
			"badgeCode": "_6yuPUG_badgeCode",
			"badgeMuted": "_6yuPUG_badgeMuted",
			"badgeOff": "_6yuPUG_badgeOff",
			"badgeOn": "_6yuPUG_badgeOn",
			"badgeWarn": "_6yuPUG_badgeWarn",
			"card": "_6yuPUG_card",
			"cardDesc": "_6yuPUG_cardDesc",
			"cardHead": "_6yuPUG_cardHead",
			"cardMeta": "_6yuPUG_cardMeta",
			"cardName": "_6yuPUG_cardName",
			"danger": "_6yuPUG_danger",
			"empty": "_6yuPUG_empty",
			"inlineButton": "_6yuPUG_inlineButton",
			"list": "_6yuPUG_list",
			"modalActions": "_6yuPUG_modalActions",
			"note": "_6yuPUG_note",
			"panel": "_6yuPUG_panel",
			"primary": "_6yuPUG_primary",
			"profile": "_6yuPUG_profile",
			"profileText": "_6yuPUG_profileText",
			"search": "_6yuPUG_search",
			"secondary": "_6yuPUG_secondary",
			"version": "_6yuPUG_version",
			"viewer": "_6yuPUG_viewer"
		};
		//#endregion
